...
async function POST(req) {
    try {
        ...
        const otp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mailer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateOtp"])();
        const otpExpiresAt = new Date(Date.now() + 10 * 60 * 1000);
        // If an unverified account already exists (user never completed OTP
        // step), update it instead of creating a duplicate.
        const user = existing ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(existing._id, {
            name,
            ...
            new: true
        }) : await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name,
            email: email.toLowerCase(),
            password: hashedPassword,
            otpCode: otp,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mailer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendOtpEmail"])(user.email, otp);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            email: user.email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21bodzx._.js.map