...
export default function EditArticlePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) throw new Error(data.error || "The article could not be updated.");
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <h1 className="font-serif-display text-2xl font-bold mb-6">Edit article</h1>
        ...
        <div>
          ...
          <label className="flex flex-col items-center justify-center gap-2 border-2 border-dashed border-line rounded-lg p-6 cursor-pointer hover:border-accent transition-colors">
            {imagePreview || coverImage ? (
              ...
              <img src={imagePreview || coverImage} alt="Preview" className="max-h-48 object-contain" />
            ) : (
              <>
